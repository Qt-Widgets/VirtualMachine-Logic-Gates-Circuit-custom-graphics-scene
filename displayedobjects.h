...
public:
    ...
    virtual const bool simplifiedAreaContainsPoint(const QPointF &point) override { throw new std::runtime_error("Is not to be invoked"); }//TODO: deal with "simplifiedAreaContainsPoint" overall
	void processMouseButtonUp(const QPointF &p) override;
